...
This script will create a new Proxmox VM with HassOS Release-3 build 6 (RC) version of Home Assistant. To create a new VM, run the following in a SSH session or the console from Proxmox interface

```
bash -c "$(wget -qLO - https://github.com/Fusion-Z/proxmox_hassos_install/raw/master/install.sh)"
```
